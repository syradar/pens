// import "./index.css"
import { type TemplateRenderer, getTemplateRenderer } from "./lib/template.js"
...
function getMockData(): MockedData[] {
  return [
    {
      category: "Technology",
...
async function fetchContrived(): Promise<{
  json: () => Promise<{ Items: MockedData[] }>
}> {
...
async function fetchAndDisplayResults(
  templateRenderer: TemplateRenderer<MockedData>
) {
  try {
...
async function initApp() {
  ...
  const templateRenderer = getTemplateRenderer<MockedData>({
